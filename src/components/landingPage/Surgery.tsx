    ...
    <TwoColumnSection color="white" containerClassName="container" reverse>
      <div>
        ...
        <h5 className={H5_CLASS_NAME}>
          Zawsze przed podjęciem decyzji o tym czy znamię powinno zostać
          usunięte chirurgicznie czy też może być bezpiecznie usunięte laserowo
          należy wykonać badanie dermatoskopowe.
        </h5>
        <div className="section_text">
          Na podstawie wykonanego badanie znamion lekarz kwalifikuje pacjenta do
          odpowiedniej metody. Chirurgicznie należy usunąc każde atypowe znamię
          na skórze. Metodą nieinwazyjną można usunąć jedynie zmiany łagodne.
          Należy jednak pamiętać, że przy usuwaniu znamion metodą laserową,
          krioterapii lub elektrokoagulacji nie ma możliwości wykonania badania
