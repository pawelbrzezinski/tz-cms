---
templateKey: article
title: Dermatoskopia - badanie znamion
...
toc:
  ...
  - link: id2
    label: Reguła ABCDE
  - link: id3
    label: Efektywność badań dermatoskopowych
  - link: id4
    label: Wskazania do dermatoskopowego badania znamion
  - link: id5
    label: Ile to kosztuje?
  - link: id6
    label: Przeciwwskazania do badania dermatoskopowego
  - link: id7
    label: Gdzie się badać?
  - link: id8
    label: A może bezpłatne badanie znamion na NFZ?
  - link: id9
    label: Jak przygotować się do badania znamion?
  - link: id10
    label: Jak wygląda dermatoskopowe badanie znamion?
  - link: id11
    label: Wideodermatoskopia - komputerowe badanie znamion
  - link: id12
    label: Czy badać tylko niepokojące znamiona?
  - link: id13
    label: Jak często badać znamiona?
  - link: id14
    label: Mikroskopia konfokalna w diagnostyce zmian skórnych
  - link: id15
    label: Rodzaje dermatoskopów
  - link: id16
    label: Główne metody lekarskiej oceny dermatoskopowej
...
![dermatoskop ręczny](img/dermosckop_reczny.jpg "dermatoskop ręczny")
...
![Klasyczny dermatoskopowy obraz czerniaka](img/czerniak_mikroskopowe_zdjecie.jpg "Klasyczny dermatoskopowy obraz czerniaka")
![Klasyczny dermatoskopowy obraz czerniaka](img/czerniak_dermatoskopia.jpg "Klasyczny dermatoskopowy obraz czerniaka")
...
![Obraz świerzbu w badaniu dermatoskopowym](img/swierzb.jpg "Obraz świerzbu w badaniu dermatoskopowym")
...
![Asymetria](img/a.jpg "Asymetria")
![Brzegi](img/b.jpg "Brzegi")
![Colour - kolor](img/c.jpg "Colour - kolor")
![Duży rozmiar](img/d.jpg "Duży rozmiar")
![Ewolucja](img/e.jpg "Ewolucja")
...
![profilaktya](img/profilaktya.jpg "profilaktya")
...
![Badanie SCREEN](img/badanie_screen.png "Badanie SCREEN")
...
![Czerniak u pacjenta z zespołem znamion dysplastycznych.](img/czerniak_makro.jpg "Czerniak u pacjenta z zespołem znamion dysplastycznych.")
![Czerniak u pacjenta z zespołem znamion dysplastycznych.](img/czerniak_mikro.jpg "Czerniak u pacjenta z zespołem znamion dysplastycznych.")
![Zespół znamion dysplastycznych](img/zespol_znamion_dysplastycznych.jpg "Zespół znamion dysplastycznych")
* z licznymi piegami na ciele
![piegi](img/piegi.png "piegi")
* z jasną karnacją (jasne lub rude włosy, często niebieskie tęczówki)
![jasna karnacja](img/jasna_karnacja.png "jasna karnacja")
...
![ciąża](img/ciaza.jpg "ciąża")
* ulegające poparzeniom słonecznym w dzieciństwie, szczególnie przed 12 rokiem życia
![dzieci przed 12 rokiem życia](img/dziecko_plaza.jpg "dzieci przed 12 rokiem życia")
...
![badanie znamion u dzieci](img/dziecko.jpg "badanie znamion u dzieci")
...
![nie usuwaj znamion laserowo bez badania dermatoskopowego](img/kosmetyczka.png "nie usuwaj znamion laserowo bez badania dermatoskopowego")
...
![obraz dermatoskopowy znamienia w okolicy pokrytej włosami](img/zdjecie_mikroskopowe_znamienia.png "obraz dermatoskopowy znamienia w okolicy pokrytej włosami")
...
![Wywiad z pacjentem zbierany przed badaniem dermatoskopowym przez lekarza.](img/wywiad_przed_badaniem_dermatoskopowym.png "Wywiad z pacjentem zbierany przed badaniem dermatoskopowym przez lekarza.")
...
![Karta konsultacyjna pacjenta](img/kartak_konsultacyjna.png "Karta konsultacyjna pacjenta")
![Karta konsultacyjna pacjenta](img/kartak_konsultacyjna2.png "Karta konsultacyjna pacjenta")
...
![mapowanie znamion](img/FotoFinder.jpg "mapowanie znamion")
...
![regularne badania znamion](img/calendar.jpg "regularne badania znamion")
...
![algorytm polskiego towarzystwa chirurgii onkologicznej](img/algorytm.png "algorytm polskiego towarzystwa chirurgii onkologicznej")
...
![mikroskop konfokalny](img/mikroskop_konfokalny.jpg "mikroskop konfokalny")
...
![diagnostyka czerniaka skóry z wykorzystaniem refleksyjnej mikroskopii konfokalnej](img/1_diagnostyka_czerniaka_skory_z_wykorzystaniem_refleksyjnej_mikroskopii_konfokalnej.jpg "diagnostyka czerniaka skóry z wykorzystaniem refleksyjnej mikroskopii konfokalnej")
...
![obraz mikroskopu konfokalnego](img/konfokalny.png "obraz mikroskopu konfokalnego")
...
![badanie znamion dermatoskopem ręcznym](img/badanie_znamion_dermatoskop_reczny.jpg "badanie znamion dermatoskopem ręcznym")
...
![Dermatoskop ręczny Delta 20 T, powiększenie 10-16 x.](img/delta.jpg "Dermatoskop ręczny Delta 20 T, powiększenie 10-16 x.")
![Dermatoskop ręczny Delta NC2, powiększenie do 10 x.](img/dermatoskop_telefon.jpg "Dermatoskop ręczny Delta NC2, powiększenie do 10 x.")
![Dermatoskop ręczny Handysope, powiększenie do 20 x, nakładka współpracuje z iPhonem oraz Ipodem Touch](img/handy.png "Dermatoskop ręczny Handysope, powiększenie do 20 x, nakładka współpracuje z iPhonem oraz Ipodem Touch")
...
![Schemat wszystkich podstawowych struktur występujących w zmodyfikowanej analizie wzorca- Harald Kittler.](img/wzorzec.png "Schemat wszystkich podstawowych struktur występujących w zmodyfikowanej analizie wzorca- Harald Kittler.")
...
![Czerniak złośliwy - ocena na podstawie 3-punktowej skali dermoskopowej. (Dermatoskopia - H.P. Soyer; G. Argenziano; R. Hofmann-Wallenhof; I. Zalaudek)](img/trzypunktowa.png "Czerniak złośliwy - ocena na podstawie 3-punktowej skali dermoskopowej. ")
...
![Znamię - ocena na podstawie 3-punktowej skali dermatoskopowej. (Dermatoskopia - H.P. Soyer; G. Argenziano; R. Hofmann-Wallenhof; I. Zalaudek)](img/trzypunktowa2.png "Znamię - ocena na podstawie 3-punktowej skali dermatoskopowej. ")
