...
description: Metody niechirurgiczne dopuszczalne są tylko wtedy, gdy znamiona mają charakter łagodny. Można je stosować u osób w każdym wieku i są one całkowicie bezinwazyjne, co oznacza, że nie dochodzi do przerwania powłok skórnych. Jednak to nie do nas należy wybór, czy znamię zostanie usunięte metodą niechirurgiczną czy chirurgiczną - decyduje o tym lekarz.
keywords:
  - usuwanie znamion
...
toc:
  ...
  - link: id2
    label: Laserowe usuwanie znamion
  - link: id3
    label: Kriochirurgia
  - link: id4
    label: Elektrokoagulacja
  - link: id5
    label: Chirurgiczne usuwanie znamion
tags:
  - czerniak
  - dermatoskopia
  - badanie znamion
...
![Laser frakcyjny CO2 - źródło: https://hyalomed.pl](img/1.png "Laser frakcyjny CO2 - źródło: https://hyalomed.pl")
...
![Kriochirurgia - źródło: https://rcz-zbaszyn.pl](img/2.jpg "Kriochirurgia - źródło: https://rcz-zbaszyn.pl")
...
![Elektrokoagulacja - źródło: https://glamour-rac.pl](img/3.jpg "Elektrokoagulacja - źródło: https://glamour-rac.pl")
